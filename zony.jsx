...
function ZonesPage() {
  ...
  return (
    <div className="page">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.45fr 1fr", gap: 24 }} className="hero-grid">
        <div>
          <div className="pitch-wrap">
            <PitchSVG>
              ...
              <text
                ...
                textAnchor="middle" fontSize="2.4" fontWeight="800"
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div className="card" style={{ background: p.color, borderColor: "var(--navy)", padding: 22 }}>
            ...
            <p style={{ marginTop: 12, fontSize: 15 }}>{p.summary}</p>
          </div>
          ...
          <div className="card" style={{ background: phase === "attack" ? "#fff3df" : "#e6ecf3", borderColor: "var(--navy)" }}>
            ...
            <ul style={{ paddingLeft: 18, lineHeight: 1.7, margin: 0, fontSize: 15 }}>
              {tips.map((t, i) => <li key={i}>{t}</li>)}
            </ul>
          </div>

          <div className="card dark">
            <div className="display" style={{ fontSize: 16, color: "#ff8a7a", marginBottom: 8 }}>⚠ Čeho se vyvaruj</div>
            <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0, fontSize: 14, opacity: 0.95 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 12 }}>
        {ZONES.map(z => (
          <button key={z.id} className="tile" onClick={() => setActive(z.id)} style={{
            padding: 14,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ textAlign: "left" }}>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", color: "var(--navy-soft)" }}>{z.short}</div>
                <div style={{ fontFamily: "Bricolage Grotesque, sans-serif", fontWeight: 800, fontSize: 15, lineHeight: 1.1 }}>{z.name}</div>
              </div>
            </div>
          </button>
        ))}
      ...
      <div className="card green" style={{ display: "grid", gridTemplateColumns: "auto 1fr", gap: 18, alignItems: "center" }}>
        <Mascot size={72} mood="wink" bounce/>
        <div>
          <div className="display" style={{ fontSize: 22 }}>Pamatuj si to nejdůležitější</div>
...
Object.assign(window, { ZonesPage });
